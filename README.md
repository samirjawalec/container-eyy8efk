...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-eyy8efk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-eyy8efk.containers.anotherwebservice.com/
...
```
git clone git@github.com:samirjawalec/container-eyy8efk.git
cd container-eyy8efk
```
...
```
docker attach container-eyy8efk
```
